...
namespace Main\Proxies\__CG__\Main\Model\Entry;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Group extends \Main\Model\Entry\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'owner', 'rating', 'public', 'entries', 'id', '_errors', '_readonly'];
        }
    ...
    public function addToEntries($value, $keepConsistency = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addToEntries', [$value, $keepConsistency]);

        return parent::addToEntries($value, $keepConsistency);
    }
