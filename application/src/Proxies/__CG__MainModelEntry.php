 ...
 */
class Entry extends \Main\Model\Entry implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'description', 'difficulty', 'group', 'id', '_errors', '_readonly'];
        }
    ...
    public function showDifficulty()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'showDifficulty', []);

        return parent::showDifficulty();
    }
